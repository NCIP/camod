...
public class BeanWSImpl implements JETTemplate{
  ...
  protected final String TEXT_5 = ".*;" + NL + "/**" + NL + " * <!-- LICENSE_TEXT_START -->" + NL + " * <!-- LICENSE_TEXT_END -->" + NL + " */" + NL + "public class ";
  protected final String TEXT_6 = "Impl extends ";
