...
public class StrainTest extends TestCase{
    ...
    private static Logger _logger = Logger.getLogger(StrainTest.class);
    
	public static final Class CLASS = StrainTest.class;
	...
	public static junit.framework.Test suite() {
		...
		//suite.addTest(new StrainTest("testPopulate"));
		suite.addTest(new StrainTest("testRetrieve"));
	...
	public void testPopulate(){
		try{
		        gov.nih.nci.camod.domain.ws.Strain strain = new gov.nih.nci.camod.domain.ws.Strain() ;
			save(strain);
		}catch(Exception ex){
		    ex.printStackTrace();
		    fail("Error retrieving Strain. Got " + ex.getClass().getName() + ": " + ex.getMessage());
	...
	public void testRetrieve(){
		try{
			...
			sess.createCriteria(gov.nih.nci.camod.domain.ws.Strain.class).list();
			tx.commit();
	...
	((gov.nih.nci.camod.domain.ws.Strain)obj).setId(new java.lang.Long("1"));
