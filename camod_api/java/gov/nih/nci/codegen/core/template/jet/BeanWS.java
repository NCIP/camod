...
public class BeanWS implements JETTemplate{
  ...
  protected final String TEXT_3 = ".ws;" + NL + "import ";
  protected final String TEXT_4 = ".ws.*;" + NL + "import ";
  protected final String TEXT_5 = ".*;" + NL + "import gov.nih.nci.system.applicationservice.*;" + NL + "import java.util.*;" + NL + "/**" + NL + " * <!-- LICENSE_TEXT_START -->" + NL + " * <!-- LICENSE_TEXT_END -->" + NL + " */" + NL + "" + NL + "public ";
  protected final String TEXT_6 = " ";
  protected final String TEXT_7 = " class ";
  protected final String TEXT_8 = " ";
  protected final String TEXT_9 = NL + "    extends ";
  protected final String TEXT_10 = NL + "\timplements java.io.Serializable" + NL + "{" + NL + "\tprivate static final long serialVersionUID = 1234567890L;" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_22 = ";" + NL + "\t   }" + NL + "\t   " + NL + "\t   public void set";
  ...
  protected final String TEXT_37 = NL + "\t\t\tprivate java.util.Collection ";
  protected final String TEXT_38 = " = new java.util.HashSet();" + NL + "\t\t\tpublic java.util.Collection get";
  protected final String TEXT_39 = "(){" + NL + "\t              return ";
  protected final String TEXT_40 = ";" + NL + "\t          }" + NL + "\t\t\t   " + NL + "\t\t\t   " + NL + "\t\t\t   " + NL + "\t\t\t   \t\t\t   " + NL + "\t      ";
  protected final String TEXT_41 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_42 = NL + "\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tprivate ";
  protected final String TEXT_43 = " ";
  protected final String TEXT_44 = ";" + NL + "\t\t\tpublic ";
  protected final String TEXT_45 = " get";
  protected final String TEXT_46 = "(){" + NL + "\t\t\t  return null;\t\t\t" + NL + "                        }" + NL + "\t\t   " + NL + "\t      ";
