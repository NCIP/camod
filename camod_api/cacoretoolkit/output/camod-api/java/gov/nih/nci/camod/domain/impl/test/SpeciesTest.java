...
public class SpeciesTest extends TestCase{
    ...
    private static Logger _logger = Logger.getLogger(SpeciesTest.class);
    
	public static final Class CLASS = SpeciesTest.class;
	...
	public static junit.framework.Test suite() {
		...
		//suite.addTest(new SpeciesTest("testPopulate"));
		suite.addTest(new SpeciesTest("testRetrieve"));
	...
	public void testPopulate(){
		try{
		        gov.nih.nci.camod.domain.ws.Species species = new gov.nih.nci.camod.domain.ws.Species() ;
			save(species);
		}catch(Exception ex){
		    ex.printStackTrace();
		    fail("Error retrieving Species. Got " + ex.getClass().getName() + ": " + ex.getMessage());
	...
	public void testRetrieve(){
		try{
			...
			sess.createCriteria(gov.nih.nci.camod.domain.ws.Species.class).list();
			tx.commit();
	...
	((gov.nih.nci.camod.domain.ws.Species)obj).setId(new java.lang.Long("1"));
