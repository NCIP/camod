	...
	implements java.io.Serializable
{
	private static final long serialVersionUID = 1234567890L;
	   ...
	   public void setIsToolMouse(Boolean isToolMouse){
	      this.isToolMouse = isToolMouse;
	   	...
	   	public void setMicroArrayDataCollection(java.util.Collection microArrayDataCollection){
			...
			private gov.nih.nci.camod.domain.ws.RepositoryInfoImpl repositoryInfo;
			public gov.nih.nci.camod.domain.ws.RepositoryInfoImpl getRepositoryInfo(){
			  return null;			
                        }
	   ...
	   public void setRepositoryInfo(gov.nih.nci.camod.domain.ws.RepositoryInfoImpl repositoryInfo){
		this.repositoryInfo = repositoryInfo;
	   	...
	   	public void setAnimalAvailabilityCollection(java.util.Collection animalAvailabilityCollection){
			...
			private gov.nih.nci.camod.domain.ws.PhenotypeImpl phenotype;
			public gov.nih.nci.camod.domain.ws.PhenotypeImpl getPhenotype(){
			  return null;			
                        }
	   ...
	   public void setPhenotype(gov.nih.nci.camod.domain.ws.PhenotypeImpl phenotype){
