 ...
 * @author dgeorge
 * 
 * $Id: QueryManagerImpl.java,v 1.5 2005-09-26 14:04:14 georgeda Exp $
 * 
...
public class QueryManagerImpl extends BaseManager {
	 ...
	 * @throws PersistenceException
	 */
	public Log getCurrentLogForUser(AnimalModel inModel, Person inUser)
			throws PersistenceException {
	 ...
	 * @throws PersistenceException
	 */
	public DrugScreenResult getYeastScreenResults(Agent agent, String stage)
			throws PersistenceException {
		...
		try {
			...
			throw new PersistenceException(
					"Exception in getYeastScreenResults: " + e);
		} finally {
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.4 2005/09/16 19:30:04 guruswas
 * Display invivo data (from DTP) in the therapuetic approaches page
 * 
