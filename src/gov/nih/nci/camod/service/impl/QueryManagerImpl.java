 ...
 * @author dgeorge
 * 
 * $Id: QueryManagerImpl.java,v 1.13 2005-10-10 14:09:41 georgeda Exp $
 * 
...
public class QueryManagerImpl extends BaseManager {
	...
	public List getCommentsBySection(String inSection, Person inPerson, AnimalModel inModel)
		...
		String theHQLQuery = "from Comments as c where (c.state = 'Screened-approved' or c.submitter = :party_id) and c.cancerModel in ("
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.12 2005/10/05 20:27:59 guruswas
 * implementation of drug screening search page
 * 
 * Revision 1.11 2005/10/05 15:23:34 georgeda Changed the theraputic approaches
 * query to return all models w/ TA's if the search string passed in was blank
 * Revision 1.10 2005/10/05 13:04:47 georgeda Completed advanced search Revision
 * 1.9 2005/10/04 20:19:43 georgeda Updates from search changes Revision 1.6
 * 2005/09/27 16:46:59 georgeda Added environmental factor dropdown query
 * Revision 1.5 2005/09/26 14:04:14 georgeda Use HQL instead of SQL Revision 1.4
 * 2005/09/16 19:30:04 guruswas Display invivo data (from DTP) in the
 * therapuetic approaches page
 * 
