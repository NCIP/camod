...
public class LogManagerImpl extends BaseManager implements LogManager
{
     ...
     * @throws Exception
     */
    public Log getCurrentByModelAndAssigned(AnimalModel inModel,
                                            Person inUser) throws Exception
    {
     ...
     * @throws Exception
     */
    public Log getCurrentByCommentsAndAssigned(Comments inComments,
                                               Person inUser) throws Exception
    {
