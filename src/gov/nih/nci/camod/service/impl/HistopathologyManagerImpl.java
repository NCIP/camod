 ...
 * @author pandyas
 * 
 * $Id: HistopathologyManagerImpl.java,v 1.2 2005-11-03 21:47:48 georgeda Exp $
 * 
...
public class HistopathologyManagerImpl extends BaseManager implements HistopathologyManager {
    ...
    public void updateAssociatedMetastasis(AssociatedMetastasisData inAssociatedMetastasisData,
            Histopathology inHistopathology, String inAssociatedMetastasisID) throws Exception {
    ...
    private void populateAssociatedMetastasis(Histopathology inHistopathology,
            AssociatedMetastasisData inAssociatedMetastasisData) {

        log.info("<HistopathologyManagerImpl> Entering populateMetastasis");

        // create new Histopathology to be used as the current associated
        // metastasis
         ...
         * with converting name back and forth
         */
        String preferedOrganName = EvsTreeUtil.getEVSPreferedDescription(inAssociatedMetastasisData
                .getOrganTissueCode());
        ...
        System.out.println("inAssociatedMetastasisData.getOrganTissueCode(): "
                + inAssociatedMetastasisData.getOrganTissueCode());
         ...
         * Add a Disease to AnimalModel with correct IDs, conceptCode
         */
        Disease inDisease = new Disease();
        inDisease.setConceptCode(inAssociatedMetastasisData.getDiagnosisCode());
        inDisease.setName(EvsTreeUtil.getEVSPreferedDescription(inAssociatedMetastasisData.getDiagnosisCode()));
        ...
        System.out.println("inHistopathologyData.getComparativeData():  "
                + inAssociatedMetastasisData.getComparativeData());
        ...
        // Histopathology attributes that need units appended
        associatedMetastasis.setAgeOfOnset(inAssociatedMetastasisData.getAgeOfOnset() + " "
                + inAssociatedMetastasisData.getAgeUnit());
        ...
        associatedMetastasis.getGeneticAlteration().setMethodOfObservation(
                inAssociatedMetastasisData.getMethodOfObservation());
    ...
    private void editAssociatedMetastasis(Histopathology inHistopathology,
            AssociatedMetastasisData inAssociatedMetastasisData, String inAssociatedMetastasisID) {
        ...
        for (int i = 0; i < assocMetastasisList.size(); i++) {
            ...
            /*
             * Match histopathology_id in DB to the curent id
             * (inAssociatedMetastasisID) or a duplicate histopathology entry
            ...
            if (associatedMetastasis.getId().toString().equals(inAssociatedMetastasisID)) {
                ...
                if (associatedMetastasis.getDiseaseCollection().size() > 0) {
                    ...
                    inDisease.setConceptCode(inAssociatedMetastasisData.getDiagnosisCode());
                    inDisease.setName(EvsTreeUtil.getEVSPreferedDescription(inAssociatedMetastasisData
                            .getDiagnosisCode()));
