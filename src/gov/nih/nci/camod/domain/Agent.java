...
public class Agent extends EnvironmentalFactor {
	...
	/**
	 * @param biologicalProcessCollection The biologicalProcessCollection to set.
	 */
	...
	/**
	 * @param biologicalProcess The biologicalProcess to add.
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().appendSuper(super.equals(object)).append(
				...
				this.biologicalProcessCollection,
				rhs.biologicalProcessCollection).append(this.isCMAPAgent,
				rhs.isCMAPAgent).append(this.nscNumber, rhs.nscNumber).append(
				this.agentTargetCollection, rhs.agentTargetCollection).append(
				this.chemicalClassCollection, rhs.chemicalClassCollection)
				.append(this.evsId, rhs.evsId).append(this.source, rhs.source)
				.isEquals();
	}
	/**
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(1778933711, 682933745).appendSuper(
				super.hashCode()).append(this.comments).append(
				this.biologicalProcessCollection).append(this.isCMAPAgent)
				.append(this.nscNumber).append(this.agentTargetCollection)
				.append(this.chemicalClassCollection).append(this.evsId)
				.append(this.source).toHashCode();
	}
	/**
	 * @see java.lang.Object#toString()
	 */
	public String toString() {
		return new ToStringBuilder(this).append("chemicalClassCollection",
				this.chemicalClassCollection).append("name", this.getName())
				.append("inducedMutationCollection",
						this.getInducedMutationCollection()).append("source",
						this.source).append("id", this.getId()).append(
						"comments", this.comments).append(
						"agentTargetCollection", this.agentTargetCollection)
				.append("CMAPAgent", this.getIsCMAPAgent()).append("casNumber",
						this.getCasNumber()).append("type", this.getType())
				.append("biologicalProcessCollection",
						this.biologicalProcessCollection).append("evsId",
						this.evsId).append("nscNumber", this.nscNumber)
				.toString();
	}
}
