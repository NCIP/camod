...
public class Phenotype extends BaseObject implements Serializable {
	...
	/**
	 * @param breedingNotes The breedingNotes to set.
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.description, rhs.description).append(this.sexDistribution,
				rhs.sexDistribution).append(this.breedingNotes,
				rhs.breedingNotes).append(this.id, rhs.id).isEquals();
	}
	/**
	 * @see java.lang.Object#hashCode()
	 */
	public int hashCode() {
		return new HashCodeBuilder(640880873, -980896221).append(this.description).append(
				this.sexDistribution).append(this.breedingNotes)
	...
	public String toString() {
		return new ToStringBuilder(this).append("sexDistribution",
				this.sexDistribution).append("id", this.id).append(
				"description", this.description).append("breedingNotes",
				this.breedingNotes).toString();
	}
}
