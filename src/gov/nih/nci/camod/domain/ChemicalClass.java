...
public class ChemicalClass extends BaseObject implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.chemicalClassName, rhs.chemicalClassName).append(this.id,
				rhs.id).isEquals();
	}
	/**
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(49852395, -176306847).append(this.chemicalClassName)
	...
	public String toString() {
		return new ToStringBuilder(this).append("chemicalClassName",
				this.chemicalClassName).append("id", this.id).toString();
	}
}
