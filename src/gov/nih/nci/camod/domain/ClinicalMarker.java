...
public class ClinicalMarker extends BaseObject implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.value, rhs.value).append(this.name, rhs.name).append(
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(1432642195, 417939691).append(this.value).append(this.name).append(
				this.id).toHashCode();
	}
	/**
	...
	public String toString() {
		return new ToStringBuilder(this).append("name", this.name).append("id",
				this.id).append("value", this.value).toString();
	}
}
