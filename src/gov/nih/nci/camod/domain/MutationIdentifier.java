...
public class MutationIdentifier extends BaseObject implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.numberMGI, rhs.numberMGI).append(this.id, rhs.id)
				.isEquals();
	}
	/**
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(642166741, 2129744149).append(this.numberMGI).append(this.id)
				.toHashCode();
	}
	/**
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id).append(
				"numberMGI", this.numberMGI).toString();
	}
}
