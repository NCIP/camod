...
public class Disease extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.name, rhs.name).append(this.conceptCode, rhs.conceptCode).append(
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-211577967, 1317175173).append(this.name).append(this.conceptCode).append(this.id)
                .toHashCode();
    }
