...
public class ExpressionLevelDesc extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.expressionLevel, rhs.expressionLevel).append(this.id, rhs.id).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(493009911, -1296889097).append(this.expressionLevel).append(this.id).toHashCode();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("expressionLevel", this.expressionLevel)
                .toString();
    }
}
