...
public class Taxon extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.scientificName, rhs.scientificName).append(this.ethnicityStrain,
                rhs.ethnicityStrain).append(this.abbreviation, rhs.abbreviation)
                .append(this.commonName, rhs.commonName).append(this.id, rhs.id).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1425898483, 492718709).append(this.scientificName).append(this.ethnicityStrain)
                .append(this.abbreviation).append(this.commonName).append(this.id).toHashCode();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("commonName", this.commonName).append(
                "ethnicityStrain", this.ethnicityStrain).append("abbreviation", this.abbreviation).append(
