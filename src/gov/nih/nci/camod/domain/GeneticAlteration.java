...
public class GeneticAlteration extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.observation, rhs.observation).append(this.methodOfObservation,
                rhs.methodOfObservation).append(this.id, rhs.id).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-1279374983, 846457973).append(this.observation).append(this.methodOfObservation)
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("methodOfObservation", this.methodOfObservation)
                .append("observation", this.observation).toString();
    }
}
