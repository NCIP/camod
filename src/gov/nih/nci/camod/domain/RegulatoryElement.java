...
public class RegulatoryElement extends BaseObject implements Serializable {
	...
	/**
	 * @param regulatoryElementType The regulatoryElementType to set.
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.regulatoryElementType, rhs.regulatoryElementType).append(
				this.taxon, rhs.taxon).append(this.name, rhs.name).append(
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1988715503, 91372047).append(this.regulatoryElementType).append(
				this.taxon).append(this.name).append(this.id).toHashCode();
	}
	/**
	...
	public String toString() {
		return new ToStringBuilder(this).append("name", this.name).append("id",
				this.id).append("regulatoryElementType",
				this.regulatoryElementType).append("taxon", this.taxon)
				.toString();
	}
}
