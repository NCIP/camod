...
public class ExpressionFeature extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.expressionLevelDesc, rhs.expressionLevelDesc).append(this.organ,
                rhs.organ).append(this.id, rhs.id).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(-288852383, -1919687697).append(this.expressionLevelDesc).append(this.organ).append(
                this.id).toHashCode();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("organ", this.organ).append(
                "expressionLevelDesc", this.expressionLevelDesc).toString();
    }
}
