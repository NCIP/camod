...
public class InvivoResult extends BaseObject implements Serializable {
	...
	/**
	 * @param percentTreatedControl The percentTreatedControl to set.
	 */
	...
	/**
	 * @param endpointCode The endpointCode to set.
	 */
	...
	/**
	 * @param evaluationDay The evaluationDay to set.
	 */
	...
	/**
	 * @param toxicityEvalDay The toxicityEvalDay to set.
	 */
	...
	/**
	 * @param toxicitySurvivors The toxicitySurvivors to set.
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.agent, rhs.agent).append(this.toxicityEvalDay,
				rhs.toxicityEvalDay)
				.append(this.endpointCode, rhs.endpointCode).append(
						this.percentTreatedControl, rhs.percentTreatedControl)
				.append(this.treatment, rhs.treatment).append(
						this.evaluationDay, rhs.evaluationDay).append(
						this.toxicitySurvivors, rhs.toxicitySurvivors).append(
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(421896029, 274365963).append(this.agent).append(
				this.toxicityEvalDay).append(this.endpointCode).append(
				this.percentTreatedControl).append(this.treatment).append(
				this.evaluationDay).append(this.toxicitySurvivors).append(
				this.id).toHashCode();
	}
	/**
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id).append(
				"toxicitySurvivors", this.toxicitySurvivors).append(
				"endpointCode", this.endpointCode).append("agent", this.agent)
				.append("percentTreatedControl", this.percentTreatedControl)
				.append("toxicityEvalDay", this.toxicityEvalDay).append(
						"treatment", this.treatment).append("evaluationDay",
						this.evaluationDay).toString();
	}
}
