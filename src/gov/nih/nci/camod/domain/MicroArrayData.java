...
public class MicroArrayData extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.availability, rhs.availability).append(this.otherLocationURL,
                rhs.otherLocationURL).append(this.experimentName, rhs.experimentName).append(this.experimentId,
                rhs.experimentId).append(this.id, rhs.id).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(1366507925, 1797915275).append(this.availability).append(this.otherLocationURL)
                .append(this.experimentName).append(this.experimentId).append(this.id).toHashCode();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", this.id).append("availability", this.availability).append(
                "experimentName", this.experimentName).append("otherLocationURL", this.otherLocationURL).append(
