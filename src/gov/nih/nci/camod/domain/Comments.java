...
public class Comments extends BaseObject implements Serializable {
	...
	/**
	 * @param modelSection The modelSection to set.
	 */
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1727118201, -1843324729).append(
				this.remark).append(this.cancerModel).append(
				this.state).append(this.availability).append(
				this.modelSection).append(this.submitter).append(
				this.id).toHashCode();
	}
	/**
	...
	public String toString() {
		return new ToStringBuilder(this).append("remark", this.remark).append(
				"state", this.state).append(
				"cancerModel", this.cancerModel).append(
				"availability", this.availability).append(
				"modelSection", this.modelSection).append(
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.remark, rhs.remark).append(
				this.state, rhs.state).append(
				this.cancerModel, rhs.cancerModel).append(
				this.availability, rhs.availability).append(
				this.modelSection, rhs.modelSection).append(
