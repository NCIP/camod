...
public class YeastModel extends AbstractCancerModel {
	...
	/**
	 * @param screeningResultCollection The screeningResultCollection to set.
	 */
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().appendSuper(super.equals(object)).append(
				...
				rhs.targetedModificationCollection).append(
				this.screeningResultCollection, rhs.screeningResultCollection)
				.isEquals();
	}
	/**
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-913323447, -593888737).appendSuper(
				super.hashCode()).append(this.targetedModificationCollection)
				.append(this.screeningResultCollection).toHashCode();
	}
	/**
	 * @see java.lang.Object#toString()
	 */
	public String toString() {
		return new ToStringBuilder(this).append("species", this.getSpecies())
				.append("state", this.getState()).append(
						"targetedModificationCollection",
						this.targetedModificationCollection).append("id",
						this.getId()).append("availability",
						this.getAvailability()).append(
						"screeningResultCollection",
						this.screeningResultCollection).append(
						"experimentDesign", this.getExperimentDesign()).append(
						"submitter", this.getSubmitter()).append(
						"principalInvestigator",
						this.getPrincipalInvestigator()).append(
