...
public class Role extends BaseObject implements Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(
				this.partyCollection, rhs.partyCollection).append(this.name,
	 ...
	 */
	public int hashCode() {
		return new HashCodeBuilder(-1816386241, -275903977).append(this.partyCollection)
	...
	public String toString() {
		return new ToStringBuilder(this).append("name", this.name).append("id",
				this.id).append("partyCollection", this.partyCollection)
				.toString();
	}
}
