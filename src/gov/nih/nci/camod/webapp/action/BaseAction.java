...
import gov.nih.nci.camod.util.ConvertUtil;
import gov.nih.nci.camod.util.CurrencyConverter;
import gov.nih.nci.camod.util.DateConverter;
import gov.nih.nci.camod.util.TimestampConverter;
import gov.nih.nci.camod.webapp.util.SslUtil;
...
public class BaseAction extends LookupDispatchAction {
    ...
    /**
     * @see gov.nih.nci.camod.util.ConvertUtil#convert(java.lang.Object)
     */
    ...
    /**
     * @see gov.nih.nci.camod.util.ConvertUtil#convertLists(java.lang.Object)
     */
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // [Sumeet]: Explanation of how this works.
        // If no method is specified then extract the method name based on the URL and
        // append to the method name. The following "if" condition comes into effect when
        // we have URLs like .../camod/editPerson.html, i.e., no method name is specified.
        // In this case the method name "edit" is extracted by examining the URL and 
        // figuring out that "edit*" appears somewhere in the URL. The method name associated
        // with the matched rule is used. So, /editProfile.html IS THE SAME AS /<action>?method=edit
