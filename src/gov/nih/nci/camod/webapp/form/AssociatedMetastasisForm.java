...
public class AssociatedMetastasisForm extends BaseForm implements Serializable,
		AssociatedMetastasisData {
	...
	/**
	 * @param parent
	 *            histopathologyID The histopathologyID to set.
	 */
	...
	/**
	 * @param parent
	 *            AbsCancerModelID The AbsCancerModelID to set.
	 */
