																									...
																									<TR>
																										<TD>
																											<TABLE cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
																												<TBODY>
																													<TR>
																														<TD class="formTitle" colspan="6" height="20">	What's 
	                                New?
																														</TD>
																													</TR>
																												</TBODY>
	                                ...
	                                the new feature?
																											...
																											<TABLE cellspacing="0" cellpadding="3" width="100%" align="center" summary="" border="0">
																												<TBODY>
																													...
																													<TR>
																														<TD class="greySubTitleLeft" width="20%">	Added 
	                                Features
																														</TD>
																														<TD class="greySubTitle" width="80%">	How to use 
	                                the new feature?
																														</TD>
																													</TR>
																													<TR>
...
<li>The Induced mutation page contains a field for Gene Entrez ID for the affected gene. If a chemical triggered the mutation the user has the option to enter the CAS number for the chemical that was used.	<li>A submission page for Spontaneous Mutation page was added.
<li>The submission pages for induced and spontaneous mutation contain fields to gather information about the genetic changes that occurred in the models as well as the methods of observation with which these changes were detected.	</ul>																											</TD>
																													</TR>
	...
	<li>All pages of the carcinogenic interventions part were updated to include fields for gender, age at treatment, and administrative route (if applicable). <li>The Chemical / Drug page allows the user to enter the NSC and/or CAS number of the chemical used in this experiment. </ul>
																														</TD>
																													</TR>
																													<TR>
	...
	<li>Users can enter data found in other species in particular humans in the ?Comparative Data? field.</ul>
																														</TD>
																													</TR>
																													<TR>
	...
	<li>The results of the experiment can be described in the biomarker and tumor response fields.</ul>
																														</TD>
																													</TR>
																													<TR>
...
<TR>
                                ...
                                of Contents
	                                ...
	                                of contents provides the user with predefined 
	                                searches and the number of records to be 
	                                returned for each query. Researchers can display 
	                                models for metastatic cancers, models with 
	                                primary tumors in specific organs or organs 
	                                systmes as well as species specific query 
	                                results.
																														</TD>
																													</TR>
																													<TR>
                                ...
                                Exposures and Dietary Regimen added
	                                ...
	                                for lung cancer have been exposed to cigarette 
	                                smoke to study the influence of smoking and 
	                                colon cancer models have been given high-fat 
	                                diets to study the effects of the diet on cancer 
	                                development. The cancer models database now 
	                                allows researchers to enter and query for this 
	                                information.
																														</TD>
																													</TR>
																												</TBODY>
