			        ...
			        <tr>
				        <td class="resultsBoxWhiteNoEnd">
			                ...
			                <td class="resultsBoxWhiteNoSides" width="25" >
				                <html:link action="/ChangeAnimalModelStateAction?event=approved" paramId="ModelId" paramName="model"  paramProperty="id">
		                            Approve
				                </html:link>
				            </td>
				            <td class="resultsBoxWhiteNoStart" width="25">
				                <html:link action="/ChangeAnimalModelStateAction?event=need_more_info" paramId="ModelId" paramName="model"  paramProperty="id">
				                    Need More Info
				                </html:link>
				            </td>
				        </td>
			    ...
			    <logic:iterate name="<%= Admin.MODELS_NEEDING_SCREENING %>" id="model" type="gov.nih.nci.camod.domain.AnimalModel">
			        <tr>
				        <td class="resultsBoxWhiteNoEnd">
				            ...
				            <td class="resultsBoxWhiteNoStart" width="25">
				                <html:link action="/ChangeAnimalModelStateAction?event=rejected" paramId="ModelId" paramName="model"  paramProperty="id">
				                    Reject
				                </html:link>
				            </td>
				        </td>
