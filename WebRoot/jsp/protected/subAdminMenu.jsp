...
<DIV>
	...
	<BR>
	<IMG height=5 alt="" src="images/subMenuArrow.gif" width=5><html:link styleClass="subMenuPrimary" action="adminCommentScreening.jsp">&nbsp;&nbsp;COMMENT SCREENING</html:link>
	<BR>
	<IMG height=5 alt="" src="images/subMenuArrow.gif" width=5><html:link styleClass="subMenuPrimary" action="AdminModelsAssignmentPopulateAction">&nbsp;&nbsp;MODEL ASSIGNMENT</html:link>
	<BR>	
