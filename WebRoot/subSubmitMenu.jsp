...
<DIV id="masterdiv">
	...
	<span class="submasterdiv" id="sub1">
		<!--&nbsp;&nbsp;&nbsp;- <html:link styleClass="subMenuBlue" action="SubmitAction.do?method=RetrieveAnimalModel&formPage=submitModelCharacteristics"><%= request.getSession().getAttribute( Constants.MODELDESCRIPTOR ) %></html:link> -->
		&nbsp;&nbsp;&nbsp;- <html:link styleClass="subMenuBlue" action="FormAction.do?method=prepopulateModelCharacteristics"><%= request.getSession().getAttribute( Constants.MODELDESCRIPTOR ) %></html:link>
		<br><br>		
	</span>
