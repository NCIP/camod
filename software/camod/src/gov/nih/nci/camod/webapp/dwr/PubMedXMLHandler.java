...
import gov.nih.nci.camod.bean.Keyword;
...
public class PubMedXMLHandler {	
	...
	private XmlPublication publication = null;
	...
	public boolean parsePubMedXML(Long pubMedId, PublicationBean pubBean) {
		...
		publication = (XmlPublication) publicationBean.getDomainFile();
		try {
	...
	public static void main(String[] args) {
		...
		XmlPublication pub = (XmlPublication) pubBean.getDomainFile();
		System.out.println("=========================================");
