 ...
 * @author pandyas
 * 
 * $Id: SubmitEditDeleteTransIntTest.java,v 1.1 2009-07-13 17:45:12 pandyas Exp $
 *
 * $Log: not supported by cvs2svn $
 * Revision 1.1  2009/07/07 17:46:54  pandyas
 * modified according to the recommended directory layout for BDA
 *
 * Revision 1.4  2006/11/09 17:10:05  pandyas
 * modified sucess, edit, and delete message to be used for both SiRNA and Morpholino.  Modified code to use only one manager so both messages must be generic.
 *
