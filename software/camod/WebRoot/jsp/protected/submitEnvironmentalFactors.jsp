...
<tr><td>
	...
	<tr>
		...
		<td class="formRequiredLabel"><label for="eName">Environmental Factor:</label></td>
		<td class="formField">		
			<br>
			(if Enviromental Factor is not listed, then please<br>select "Other" from the list and specify it below)
			<br>
			<br>			
			<html:select styleClass="formFieldSized" size="1" styleId="eName" property="name"  onclick="chkOtherName();">												
		...
		<tr>
			<td class="formRequiredNotice" width="5">&nbsp;</td>
			<td class="formLabel"><label for="otherName">Other Environmental Factor:</label></td>
			<td class="formField">					
