...
<tr><td>
	...
	<tr>
		<td class="formTitle" height="20" colspan="3">Viral Treatment
			<camod:cshelp topic="viral_treatment_help" key="ignore" image="/camod/images/iconHelp.gif" text=""/></td>
	</tr>

	<tr>
		<td class="formRequiredNotice" width="5">*</td>
		<td class="formRequiredLabel"><label for="vName">Virus:</label></td>

		<td class="formField">
		<br>
		(if Virus is not listed, then please<br>select "Other" from the list and specify it below)
		<br><br>
			<html:select styleClass="formFieldSized" size="1" styleId="vName" property="name"  onclick="chkOtherName( this );">												
	...
	<tr>
		<td class="formRequiredNotice" width="5">&nbsp;</td>
		<td class="formLabel"><label for="otherName">Other Virus:</label></td>
		<td class="formField">
	...
	<tr>
		...
		<td class="formField">
			...
			<br>
			<br>
			<html:select styleClass="formFieldSized" size="1" styleId="administrativeRoute" property="administrativeRoute"  onclick="chkOtherAdminRoute(this);">												
	...
	<tr>
		...
		<td class="formField">
			<html:text styleClass="formFieldSized" styleId="otherAdministrativeRoute" property="otherAdministrativeRoute"  size="30" />
		</td>
	</tr>
