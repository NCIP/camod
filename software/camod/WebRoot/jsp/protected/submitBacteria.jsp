...
<!-- -->
	...
	<tr>
		...
		<td class="formRequiredLabel"><label for="field3">Bacteria:</label></td>				
		<td class="formField">
			<br>
			<label for="field3">(if Bacteria is not listed, then please<br>select "Other" from the list and specify it below)</label>
			<br><br>
	...
	<tr>
		<td class="formRequiredNotice" width="5">&nbsp;</td>
		<td class="formLabel"><label for="field1">Other Bacteria:</label></td>
		<td class="formField">
