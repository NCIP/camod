...
<!-- submitHormone.jsp -->
<!-- Main Content Begins -->			
<TABLE summary="This table is used to format page content" cellpadding="" cellspacing="0" border="0" class="contentBegins" width="100%" height="100%">
...
<!-- -->
	...
	<tr>
		...
		<td class="formRequiredLabel"><label for="hName">Hormone:</label></td>				
		<td class="formField">
			<br>
			(if Hormone is not listed, then please<br>select "Other" from the list and specify it below)
			<br><br>
			<html:select styleClass="formFieldSized" size="1" styleId="hName" property="name"  onclick="chkOtherName();">												
	...
	<tr>
		<td class="formRequiredNotice" width="5">&nbsp;</td>
		<td class="formLabel"><label for="otherName">Other Hormone:</label></td>
		<td class="formField">
