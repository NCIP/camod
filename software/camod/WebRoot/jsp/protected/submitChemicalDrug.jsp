...
<tr><td>
	...
	<tr>
			...
			<td class="formField">		
				...
				'left=20,top=20,width=700,height=700,status=1,scrollbars=1,toolbar=1,resizable=1');myRef.focus()"></input>
				&nbsp;&nbsp;
				<html:text styleClass="formFieldUnSized" size="15" styleId="casNumber" property="casNumber"  />&nbsp;&nbsp;<a class="sideMenuLink" href="html/disclaimer.html" target="new">Disclaimer</a>
			</td>
	</tr>	
