                                      ...
                                      <tr>
                                          <td valign="top">
                                              <table summary="" cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" class="sidebarSection">
                                                  ...
                                                  <tr>
                                                      <td class="sidebarContent" valign="top">caMOD 2.6.1 was released to production in June 2010.<br/><br/>
                                                  ...
                                                  <tr>
													<td> &nbsp; 
														<input type="submit" value="User Guide" onClick="myRef = window.open('camod/WebRoot/WebHelp/caMOD/UserGuide.pdf','mywin',
															'left=20,top=20,width=900,height=700,status=1,scrollbars=1,toolbar=1,resizable=1');myRef.focus()"/>
														&nbsp;
														<input type="submit" value="Help" onClick="myRef = window.open('camod/WebRoot/WebHelp/caMOD/index.html','mywin',
